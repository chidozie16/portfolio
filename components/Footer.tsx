    ...
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      <div className="w-full absolute left-0 -bottom-72 min-h-96">
        <img
          src="/footer-grid.svg"
          alt="grid"
          className="w-full h-100% opacity-50 "
        />
      </div>

      <div className="flex flex-col items-center">
        <h1 className="text-center text-white text-[40px] md:text-5xl lg:text-4xl">
          Ready to <span className="text-purple-300">experience</span> a new
          digital presence
        </h1>
        ...
        <a href="mailto:chidozievictor607@gmail.com">
          <MagicButton
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm text-white md:font-normal font-light">
          Copyright © 2026 Odogwu Chidozie
        </p>
